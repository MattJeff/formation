  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-secondary p-4">
      <div className="max-w-md text-center">
        ...
        <h1 className="mb-4 text-3xl font-bold">Communauté en construction</h1>

        <p className="mb-6 text-muted-foreground">
          Notre espace communautaire avec forums, discussions et collaborations arrive bientôt !
          En attendant, commencez votre apprentissage avec nos cours.
        </p>
